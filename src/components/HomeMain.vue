      ...
      <section class="product_box">
        <div class="product_top">
          <a href="#" class="product_left">
            <img
              src="../assets/images/jd_skill.png"
              alt=""
              class="miaosha_icon"
            />
          ...
          <ul>
            <li class="product_skill_item" v-for="item in homeDatas">
              <router-link
                ...
                class="product_skill_item_link"
              >
                <img
                  v-lazy="item.product_img_url"
                  alt=""
                  class="product_skill_item_cion lazy-img-fadein"
                />
                <p class="nowprice">
                  <i
                    style="
              ...
              <li class="not_eng_item" v-for="item in mainDatas">
                ...
                >
                  <img
                    v-lazy="item.product_img_url"
                    alt=""
                    class="not_eng_pic lazy-img-fadein"
                  />
  ...
  methods: {
    ...
    setResTime() {
      let CountDown = () => {
        ...
        pm = now.getMonth();
        pd = now.getDate();
        let time = new Date(py, pm, pd, 18, 0, 0);
        let leftTime = time.getTime() - now.getTime();
        if (leftTime >= 0) {
